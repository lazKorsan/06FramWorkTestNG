...
public class C10_sayfaKaydirmaTesti extends TestBaseRapor {
    ...
    public void cokluLoginTesti(String ad, String email, String sifre){
        ...
        //======================== sayfayı yukarı doğru kaydırır
        TestregistarPage testregistarPage = new TestregistarPage();
        JavascriptExecutor js = (JavascriptExecutor) Driver.getDriver();
        js.executeScript("arguments[0].scrollIntoView(true);", testregistarPage.usernameBox);
        //========================
